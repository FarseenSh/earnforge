...
description: >
  ...
  9% of vaults as suspect. Handles all 25 known API pitfalls by default.
---
```
...
The skill documents the CLI's full surface: 20 commands, all accepting `--json`.
...
The 26 protocols with risk tiers. Used by agents to understand protocol maturity
when making recommendations.

### references/chains.md

All 17 chains with chainId mappings. Agents use this to convert between chain names
and numeric IDs.
